...
import { useGLTF, Environment, PresentationControls, ContactShadows, Html, Float } from '@react-three/drei';

function Model(props) {
    // Using a public model URL for a MacBook Pro
    ...
    return (
        <group {...props} dispose={null}>
            <group position={[0, 0.52, 0]} scale={[0.1, 0.1, 0.1]}>
                ...
                <mesh geometry={nodes.FrontCameraRing001.geometry} material={materials['CameraRIngBlack.002']} position={[-0.15, 20.72, -16.15]} scale={5.8} />
                <mesh geometry={nodes.KeyboardKeyHole.geometry} material={nodes.KeyboardKeyHole.material} position={[-11.79, -0.15, -8.3]} scale={5.8} />
                <mesh geometry={nodes.RubberFoot.geometry} material={materials.DarkRubber} position={[-11.95, -0.75, 3.96]} scale={5.8} />
                ...
                <group position={[0, -0.51, -10.41]} scale={5.8}>
